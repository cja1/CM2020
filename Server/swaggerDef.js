module.exports = {
  ...
  tags: [
    { name: 'Games', description: 'The /games endpoint is the main endpoint used for creating a new game, joining an existing game, playing a round and getting the game state.' },
  ],
  components: {
    securitySchemes: {
      bearerAuth: {
